  ...
  config = function()
    require('oldworld').setup {
      ...
      highlight_overrides = {
        ...
        StatusLineTerm = { bg = 'NONE', fg = '#c6c6c6' },
        ...
        BlinkCmpKindModule = { fg = '#c6c6c6' },
        BlinkCmpKindProperty = { fg = '#82ffac' },
        BlinkCmpKindUnit = { fg = '#c6c6c6' },
